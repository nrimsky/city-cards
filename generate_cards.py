...
def create_city_card(
    ...
    if image_path:
        ...
        if image_data:
            ...
            img_y = (CARD_HEIGHT - img_height) // 2 - 10
            additional_content.append(
                f'<g id="city-image"><image x="{img_x}" y="{img_y}" width="{img_width}" height="{img_height}" href="{image_data}" preserveAspectRatio="xMidYMid meet"/></g>'
            )

    # --- Text to Path Conversion ---
    # Create city/state info as paths
